...
# |         Cidr      |              Name                |             VpcId              |
# +-------------------+----------------------------------+--------------------------------+
# |  10.73.0.0/16     |  skills-ceh-vpc                  |  vpc-0123456789abcdef0         |
# +-------------------+----------------------------------+--------------------------------+
# -------------------------------------------------------------------------------------------------------------------------
# |                                               DescribeInstances                                                       |
# +-------------------+-----------------------+-------------------+-----------------------+-------------------------------+
# |        Id         |         Name          |  SecurityGroups   |         State         |             Type              |
# +-------------------+-----------------------+-------------------+-----------------------+-------------------------------+
# |  i-0123...        |  skills-ceh-ec2       |  sg-0123...       |  running              |  t3.micro                     |
# +-------------------+-----------------------+-------------------+-----------------------+-------------------------------+
# ---------------------------------------------------------------------------------------------------------
# |                                        DescribeSecurityGroups                                         |
# +-----------------------+------------------------------+--------------------------------+---------------+
# |        GroupId        |          GroupName           |              Name              |     VpcId     |
# +-----------------------+------------------------------+--------------------------------+---------------+
# |  sg-0123...           |  launch-wizard-1             |  skills-ceh-protected-sg       |  vpc-0123...  |
# +-----------------------+------------------------------+--------------------------------+---------------+
...
# TOPIC_ARN=arn:aws:sns:ap-southeast-1:123456789012:skills-ceh-alert-topic
# -------------------------------------------------------------------------------------------------
# |                                          ListTopics                                           |
# +-----------------------------------------------------------------------------------------------+
# |  arn:aws:sns:ap-southeast-1:123456789012:skills-ceh-alert-topic                               |
# +-----------------------------------------------------------------------------------------------+
# -----------------------------------------------------------------------------------------------------
# |                                     GetFunctionConfiguration                                      |
# +--------------------+------------------------------------------------------------------------------+
# |  FunctionName      |  skills-ceh-remediate-fn                                                     |
# |  Handler           |  remediate_security_group.lambda_handler                                     |
# |  LastUpdateStatus  |  Successful                                                                  |
# |  Role              |  arn:aws:iam::106143941813:role/skills-ceh-remediate-role-1785585277         |
# |  Runtime           |  python3.12                                                                  |
# |  State             |  Active                                                                      |
# |  Timeout           |  30                                                                          |
# +--------------------+------------------------------------------------------------------------------+
...
# |                           GetTrailStatus                              |
# +-------------------+---------------------------+-----------------------+
# |    IsLogging      |    LatestDeliveryError    |  LatestDeliveryTime   |
# +-------------------+---------------------------+-----------------------+
# |  True             |                           |  1710000000           |
# +-------------------+---------------------------+-----------------------+
# {
...
# |                          Arn                          |                      Id                       |
# +-------------------------------------------------------+-----------------------------------------------+
# |  arn:aws:lambda:ap-southeast-1:123456789012:funct...  |  1                                            |
# +-------------------------------------------------------+-----------------------------------------------+
# {"Version":"2012-10-17","Id":"default","Statement":[{"Sid":"AllowEventBridgeInvoke-1710000000","Effect":"Allow","Principal":{"Service":"events.amazonaws.com"},"Action":"lambda:InvokeFunction","Resource":"arn:aws:lambda:ap-southeast-1:123456789012:function:skills-ceh-remediate-fn","Condition":{"ArnLike":{"AWS:SourceArn":"arn:aws:events:ap-southeast-1:123456789012:rule/skills-ceh-sg-change-rule"}}}]}
...
#   "eventGroupId": "sg-0123456789abcdef0",
#   "protectedGroupId": "sg-0123456789abcdef0",
#   "requestId": "xxxx-xxxx-xxxx",
#   "revokedPermissionCount": 1,
#   "timestamp": 1710000005,
#   "publishStatus": "SNS_PUBLISHED"
# }
# poll=1
# []
# inbound_count=0
...
# |                        DescribeLogGroups                              |
# +-----------------------------------------------------------------------+
# |  /aws/lambda/skills-ceh-remediate-fn                                  |
# +-----------------------------------------------------------------------+
